...
pub async fn transcribe_with_translation(audio_path: &str, source_lang: &str, target_lang: &str, precision_mode: bool) -> Result<TranscriptionResult, String> {
  let model_path = "./models/ggml-small.en.bin";
